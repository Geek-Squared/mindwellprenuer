  ...
  return (
    <div className="about-section-container">
      ...
      <h2 className="about-section-title">About <span className="mellania-span">Mindfulwellprenuer...</span></h2>
        ...
        <p>
          <strong>One-on-One Process:</strong> I have had the honor of helping numerous clients transform their lives. My approach involves equipping you with straightforward, effective tools to foster positive change in your inner world, resulting in a life you are truly excited about.
        </p>
        <p>
          <strong>My Objective:</strong> To swiftly help you break free from feelings of being stuck, anxious, stressed, or overwhelmed, and empower you to achieve your life goals. I am deeply passionate about driving transformation for my clients.
        </p>
        <p>
